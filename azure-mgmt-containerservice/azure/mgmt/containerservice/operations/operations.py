...
class Operations(object):
    ...
    def list(
        ...
        """List the available operations for Azure Container Services.
        ...
        :rtype: ~azure.mgmt.containerservice.models.OperationListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = '/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/operations'
